...
if (!game_over) {
	...
	var length_displayed = round((length_tracker/120) * 100)/100;
	draw_text_transformed((width * 0.5), (height * 0.5), "Total Length of Roots: " + string(length_displayed) + " Barkometers", 0.5, 0.5, 0);
